...
main(int argc, char *argv[])
{
  ...
  12:	1380                	addi	s0,sp,480
  int numbers[100], cnt = 0, i;
  int fd[2];
  for (i = 2; i <= 35; i++) {
  14:	e3040913          	addi	s2,s0,-464
{
  18:	874a                	mv	a4,s2
  for (i = 2; i <= 35; i++) {
  1a:	4789                	li	a5,2
  1c:	02400693          	li	a3,36
    numbers[cnt++] = i;
  20:	c31c                	sw	a5,0(a4)
  for (i = 2; i <= 35; i++) {
  ...
  34:	808b0b13          	addi	s6,s6,-2040 # 838 <malloc+0xe8>
  38:	a8a1                	j	90 <main+0x90>
          this_prime = prime;
  3a:	e2442983          	lw	s3,-476(s0)
          cnt = 0;
  3e:	84d6                	mv	s1,s5
      while (read(fd[R], &prime, sizeof(prime)) != 0) {
  40:	4611                	li	a2,4
  42:	e2440593          	addi	a1,s0,-476
  46:	e2842503          	lw	a0,-472(s0)
  4a:	00000097          	auipc	ra,0x0
  4e:	2c8080e7          	jalr	712(ra) # 312 <read>
  52:	c10d                	beqz	a0,74 <main+0x74>
        if (cnt == -1) {
  54:	ff4483e3          	beq	s1,s4,3a <main+0x3a>
          if (prime % this_prime != 0) numbers[cnt++] = prime;
  58:	e2442783          	lw	a5,-476(s0)
  5c:	0337e73b          	remw	a4,a5,s3
  60:	d365                	beqz	a4,40 <main+0x40>
  62:	00249713          	slli	a4,s1,0x2
  66:	fc040693          	addi	a3,s0,-64
  6a:	9736                	add	a4,a4,a3
  6c:	e6f72823          	sw	a5,-400(a4)
  70:	2485                	addiw	s1,s1,1
  72:	b7f9                	j	40 <main+0x40>
      printf("prime %d\n",this_prime);
  74:	85ce                	mv	a1,s3
  76:	855a                	mv	a0,s6
  78:	00000097          	auipc	ra,0x0
  7c:	61a080e7          	jalr	1562(ra) # 692 <printf>
      // 关闭读
      close(fd[R]);
  80:	e2842503          	lw	a0,-472(s0)
  84:	00000097          	auipc	ra,0x0
  88:	29e080e7          	jalr	670(ra) # 322 <close>
  while (cnt > 0) {
  8c:	06905c63          	blez	s1,104 <main+0x104>
    pipe(fd);
  90:	e2840513          	addi	a0,s0,-472
  94:	00000097          	auipc	ra,0x0
  98:	276080e7          	jalr	630(ra) # 30a <pipe>
    if (fork() == 0) {
  9c:	00000097          	auipc	ra,0x0
  a0:	256080e7          	jalr	598(ra) # 2f2 <fork>
  a4:	8aaa                	mv	s5,a0
  a6:	e911                	bnez	a0,ba <main+0xba>
      close(fd[W]);
  a8:	e2c42503          	lw	a0,-468(s0)
  ac:	00000097          	auipc	ra,0x0
  b0:	276080e7          	jalr	630(ra) # 322 <close>
      int prime, this_prime = 0;
  b4:	89d6                	mv	s3,s5
      cnt = -1;
  b6:	84d2                	mv	s1,s4
      while (read(fd[R], &prime, sizeof(prime)) != 0) {
  b8:	b761                	j	40 <main+0x40>
    ...
    // 父进程里
      ...
      close(fd[R]);
  ba:	e2842503          	lw	a0,-472(s0)
  be:	00000097          	auipc	ra,0x0
  c2:	264080e7          	jalr	612(ra) # 322 <close>
      
      for (i = 0; i < cnt; i++) {//将上一个子进程（这一次的父进程）筛选出来的素数写入pipe
  c6:	02905563          	blez	s1,f0 <main+0xf0>
  ca:	34fd                	addiw	s1,s1,-1
  cc:	02049793          	slli	a5,s1,0x20
  d0:	01e7d493          	srli	s1,a5,0x1e
  d4:	00490793          	addi	a5,s2,4
  d8:	94be                	add	s1,s1,a5
        write(fd[W], &numbers[i], sizeof(numbers[0]));
  da:	4611                	li	a2,4
  dc:	85ca                	mv	a1,s2
  de:	e2c42503          	lw	a0,-468(s0)
  e2:	00000097          	auipc	ra,0x0
  e6:	238080e7          	jalr	568(ra) # 31a <write>
      for (i = 0; i < cnt; i++) {//将上一个子进程（这一次的父进程）筛选出来的素数写入pipe
  ea:	0911                	addi	s2,s2,4
  ec:	fe9917e3          	bne	s2,s1,da <main+0xda>
      }
      close(fd[W]);
  f0:	e2c42503          	lw	a0,-468(s0)
  f4:	00000097          	auipc	ra,0x0
  f8:	22e080e7          	jalr	558(ra) # 322 <close>
      wait();
  fc:	00000097          	auipc	ra,0x0
 100:	206080e7          	jalr	518(ra) # 302 <wait>
...
malloc(uint nbytes)
{
 ...
 7dc:	08a73823          	sd	a0,144(a4) # 868 <freep>
      return (void*)(p + 1);
